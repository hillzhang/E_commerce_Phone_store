...
<!-- end of header -->
    ...
    <div id="templatemo_content">
		...
		<div class="crumb_nav">
            <a href="index.php">Home</a> &gt;&gt; phones
            </div>	
        	
<?php			
		
			//get phones details from database
		$sql = "SELECT * FROM phones ORDER BY PHONEID";
		...
		OCIExecute($stmt); 		
		// get the total phones for paging purpose and assign the total to Num_Rows variable
...
//end of getting phones details from database
