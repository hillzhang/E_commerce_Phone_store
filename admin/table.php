<?php
  ...
  $dbpass = "linshan1206";  /* your deakin password */
  $dbname = "SSID"; 
...
function listUsers() {
		...
		$stmt2 = OCIParse($db, $sql2); 
			...
			$sql3 = 'INSERT INTO users VALUES ("linshan", "p", "ss", "39c869cf2ba63b2c17e901df0f6ba1b4", "linshan@mail.com", "123456789", "phonestore", "100 T street",1234,"Melb","Queensland");';
...
<meta name="keywords" content="product Store, products" />
