    ...
    <div id="templatemo_content">
        ...
        <div id="templatemo_content_right">
            ...
            <img src="images/about.gif" alt="" title="" class="right" /> 
             Our phone store contain the newest producted for the customers. We have been delivering an outstanding service to our worldwide customers for over 2 years.
			<br/><br/>Why choose us?<br/>
			- we can provide the newest phone products <br />
			- we can ship fast and low cost<br/>
			
			if you can not find a current products on our website, please send us an email to<br/>
			<a href="mailto:linshan@deakin.edu.au">contact email</a><br/>
            </p>
