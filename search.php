    ...
    <div id="templatemo_content">
        ...
        <div id="templatemo_content_right">
        	...
        	<div class="feat_prod_box_details">
			 ...
			 <div class="form_subtitle">Search your online phonestore</div>
			 <form action ="search.php" method="get">			 
			 <div class="form_row">
			 
			 <div class="search_box">
			 <strong>Keywords:</strong>
			 <input type="text" id="AdvKeywordSearch"  name="search" size="55" value=""/>
			<div id="advlivesearch" class="advlivesearch"></div>
			 ...
			 <div class="SearchFormatLeft_radio">
					...
					<label><input type="radio" name="find" value="company" /> Compamy</label>
...
//search all
	if($choose == "ALL") {
	global $db;
	$query = "SELECT * FROM $table WHERE LOWER(TITLE) LIKE '$searchTerm%' OR LOWER(COMPANY) LIKE '$searchTerm%' ";	
...
if($choose == "COMPANY") {
	global $db;
	$query = "SELECT * FROM $table WHERE LOWER(COMPANY) LIKE '$searchTerm%'";	
